// Seed script to add courses to the database
// Run this: node scripts/seed-courses.js
...
const addCourseSchema = new mongoose.Schema(
  {
    ...
    courseCon: [{ type: String, required: true }],
...
const courses = [
  {
    ...
    file: "https://res.cloudinary.com/de3xyhrm9/image/upload/v1234567890/web-store-courses/html-css-js.jpg",
  },
  {
    ...
    file: "https://res.cloudinary.com/de3xyhrm9/image/upload/v1234567890/web-store-courses/mongodb.jpg",
  },
  {
    ...
    file: "https://res.cloudinary.com/de3xyhrm9/image/upload/v1234567890/web-store-courses/nextjs.jpg",
  },
  {
    ...
    file: "https://res.cloudinary.com/de3xyhrm9/image/upload/v1234567890/web-store-courses/nodejs-express.jpg",
  },
  {
    ...
    file: "https://res.cloudinary.com/de3xyhrm9/image/upload/v1234567890/web-store-courses/fullstack-mern.jpg",
  },
];
...
async function seedCourses() {
  try {
    ...
    const existingCourses = await AddCourse.find();
    ...
    for (const course of courses) {
      ...
      if (exists) {
        ...
        await AddCourse.create(course);
        console.log(`✅ Added: "${course.title}" - Rs.${course.price}`);
        addedCount++;
      }
    }
    ...
    console.log(`   📊 Total courses in database: ${existingCourses.length + addedCount}`);
